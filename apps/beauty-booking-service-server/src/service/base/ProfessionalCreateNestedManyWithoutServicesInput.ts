...
@InputType()
class ProfessionalCreateNestedManyWithoutServicesInput {
...
export { ProfessionalCreateNestedManyWithoutServicesInput as ProfessionalCreateNestedManyWithoutServicesInput };
