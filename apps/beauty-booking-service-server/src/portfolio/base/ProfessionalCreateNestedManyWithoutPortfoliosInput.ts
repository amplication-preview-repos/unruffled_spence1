...
@InputType()
class ProfessionalCreateNestedManyWithoutPortfoliosInput {
...
export { ProfessionalCreateNestedManyWithoutPortfoliosInput as ProfessionalCreateNestedManyWithoutPortfoliosInput };
